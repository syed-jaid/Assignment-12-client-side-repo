...
const Summery = () => {
    return (
        <div className='lg:mt-[100px] lg:mb-[100px] mt-[50px] '>
            <h1 className='text-center text-5xl font-bold font-sans mb-[40px]'>WE PROVIDED THE CUSTOMERS MILLIONS OF SERVICES </h1>
            ...
            <div class="card w-full border-2 border-[#333333] my-[50px]">
                <div class="card-body ">
